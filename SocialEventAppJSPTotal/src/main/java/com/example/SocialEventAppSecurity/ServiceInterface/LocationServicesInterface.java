...
public interface LocationServicesInterface {
    ...
    List<BookingEventModel> getAllBookingsOfLocation(Location location);

    List<LocationModel> viewLocationBasedOnBooking();

    List<LocationModel> getAllLocationsOfOrganizer(EventOrganizer eventOrganizer);
}
