...
<div class="container">
    ...
    <br><br>
        ...
        <a href="addLocations" class="nav-link">ADD LOCATIONS</a><br><br><br>
            <a href="viewLocations" class="nav-link">VIEW ALL LOCATIONS</a><br><br><br>

        <a href="addEvents" class="nav-link">ADD EVENT</a><br><br><br>
         <a href="viewEvents" class="nav-link">VIEW ALL EVENTS </a><br><br><br>
         <a href="upcomingEvents" class="nav-link">UPCOMING BOOKINGS </a><br><br><br>
       <a href="PastEvents" class="nav-link">PAST BOOKINGS </a><br><br><br>
