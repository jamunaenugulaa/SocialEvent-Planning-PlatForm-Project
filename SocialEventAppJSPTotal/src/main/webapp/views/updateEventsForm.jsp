...
<center>
    ...
    <form:form action="updateEventCheck" modelAttribute="eventModel">
    <% EventsModel event=(EventsModel) request.getAttribute("eventModel"); %>
    <label for="eventId">Event Id:</label>
       <input name="eventId"  value="<%=event.getEventId() %>"/><br>

        <label for="eventName">Event Name:</label>
        <form:input path="eventName"  value="<%=event.getEventName() %>"/><br>
